...
public class ParisTree extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(ParisTree.class);

        job.setMapperClass(ParisTreeMapper.class);

        job.setReducerClass(ParisTreeReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ParisTree exempleDriver = new ParisTree();
