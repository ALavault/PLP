...
public class PerDocWC extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(PerDocWC.class);

        job.setMapperClass(PerDocWCMapper.class);

        job.setReducerClass(PerDocWCReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PerDocWC exempleDriver = new PerDocWC();
